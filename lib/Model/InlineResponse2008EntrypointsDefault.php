...
/**
 * InlineResponse2008EntrypointsDefault Class Doc Comment
 *
 * @category Class
 * @package  IdeaEngine\TzStats
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse2008EntrypointsDefault implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_8_entrypoints_default';
    ...
    public function setCall($call)
    {
        ...
        if ((mb_strlen($call) < 1)) {
            throw new \InvalidArgumentException('invalid length for $call when calling InlineResponse2008EntrypointsDefault., must be bigger than or equal to 1.');
        }
    ...
    public function setBranch($branch)
    {
        ...
        if ((mb_strlen($branch) < 1)) {
            throw new \InvalidArgumentException('invalid length for $branch when calling InlineResponse2008EntrypointsDefault., must be bigger than or equal to 1.');
        }
    ...
    public function setType($type)
    {
        ...
        if ((count($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling InlineResponse2008EntrypointsDefault., number of items must be greater than or equal to 1.');
        }

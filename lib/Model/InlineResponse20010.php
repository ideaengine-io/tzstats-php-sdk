...
class InlineResponse20010 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'snapshot_cycle' => '\IdeaEngine\TzStats\Model\InlineResponse20010SnapshotCycle',
        'follower_cycle' => '\IdeaEngine\TzStats\Model\InlineResponse20010SnapshotCycle'
    ];
    ...
    protected static $setters = [
        ...
        'snapshot_cycle' => 'setSnapshotCycle',
        'follower_cycle' => 'setFollowerCycle'
    ];
    ...
    protected static $getters = [
        ...
        'snapshot_cycle' => 'getSnapshotCycle',
        'follower_cycle' => 'getFollowerCycle'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['snapshot_cycle'] = $data['snapshot_cycle'] ?? null;
        $this->container['follower_cycle'] = $data['follower_cycle'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['snapshot_cycle'] === null) {
            $invalidProperties[] = "'snapshot_cycle' can't be null";
        }
        if ($this->container['follower_cycle'] === null) {
            $invalidProperties[] = "'follower_cycle' can't be null";
        }
    ...
    public function setStartTime($start_time)
    {
        ...
        if ((mb_strlen($start_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $start_time when calling InlineResponse20010., must be bigger than or equal to 1.');
        }
    ...
    public function setEndTime($end_time)
    {
        ...
        if ((mb_strlen($end_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $end_time when calling InlineResponse20010., must be bigger than or equal to 1.');
        }
    ...
    public function setSnapshotTime($snapshot_time)
    {
        ...
        if ((mb_strlen($snapshot_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $snapshot_time when calling InlineResponse20010., must be bigger than or equal to 1.');
        }
     ...
     * Gets snapshot_cycle
     *
     * @return \IdeaEngine\TzStats\Model\InlineResponse20010SnapshotCycle
     */
    public function getSnapshotCycle()
    {
        return $this->container['snapshot_cycle'];
    }

    /**
     * Sets snapshot_cycle
     *
     * @param \IdeaEngine\TzStats\Model\InlineResponse20010SnapshotCycle $snapshot_cycle snapshot_cycle
     *
     * @return self
     */
    public function setSnapshotCycle($snapshot_cycle)
    {
        $this->container['snapshot_cycle'] = $snapshot_cycle;
     ...
     * @return \IdeaEngine\TzStats\Model\InlineResponse20010SnapshotCycle
     */
    public function getFollowerCycle()
    {
        return $this->container['follower_cycle'];
    }

    /**
     * Sets follower_cycle
     *
     * @param \IdeaEngine\TzStats\Model\InlineResponse20010SnapshotCycle $follower_cycle follower_cycle
     *
     * @return self
     */
    public function setFollowerCycle($follower_cycle)
    {
        $this->container['follower_cycle'] = $follower_cycle;

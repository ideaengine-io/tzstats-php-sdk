...
class Contract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setAddress($address)
    {
        ...
        if ((mb_strlen($address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address when calling Contract., must be bigger than or equal to 1.');
        }
    ...
    public function setCreator($creator)
    {
        ...
        if ((mb_strlen($creator) < 1)) {
            throw new \InvalidArgumentException('invalid length for $creator when calling Contract., must be bigger than or equal to 1.');
        }
    ...
    public function setDelegate($delegate)
    {
        ...
        if ((mb_strlen($delegate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $delegate when calling Contract., must be bigger than or equal to 1.');
        }
    ...
    public function setFirstSeenTime($first_seen_time)
    {
        ...
        if ((mb_strlen($first_seen_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_seen_time when calling Contract., must be bigger than or equal to 1.');
        }
    ...
    public function setLastSeenTime($last_seen_time)
    {
        ...
        if ((mb_strlen($last_seen_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_seen_time when calling Contract., must be bigger than or equal to 1.');
        }
    ...
    public function setIfaceHash($iface_hash)
    {
        ...
        if ((mb_strlen($iface_hash) < 1)) {
            throw new \InvalidArgumentException('invalid length for $iface_hash when calling Contract., must be bigger than or equal to 1.');
        }
    ...
    public function setCodeHash($code_hash)
    {
        ...
        if ((mb_strlen($code_hash) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code_hash when calling Contract., must be bigger than or equal to 1.');
        }

...
class InlineResponse2005 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'value_type' => '\IdeaEngine\TzStats\Model\InlineResponse2005ValueType'
    ];
    ...
    public function setContract($contract)
    {
        ...
        if ((mb_strlen($contract) < 1)) {
            throw new \InvalidArgumentException('invalid length for $contract when calling InlineResponse2005., must be bigger than or equal to 1.');
        }
    ...
    public function setAllocBlock($alloc_block)
    {
        ...
        if ((mb_strlen($alloc_block) < 1)) {
            throw new \InvalidArgumentException('invalid length for $alloc_block when calling InlineResponse2005., must be bigger than or equal to 1.');
        }
    ...
    public function setAllocTime($alloc_time)
    {
        ...
        if ((mb_strlen($alloc_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $alloc_time when calling InlineResponse2005., must be bigger than or equal to 1.');
        }
    ...
    public function setUpdateBlock($update_block)
    {
        ...
        if ((mb_strlen($update_block) < 1)) {
            throw new \InvalidArgumentException('invalid length for $update_block when calling InlineResponse2005., must be bigger than or equal to 1.');
        }
    ...
    public function setUpdateTime($update_time)
    {
        ...
        if ((mb_strlen($update_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $update_time when calling InlineResponse2005., must be bigger than or equal to 1.');
        }
     ...
     * Gets value_type
     *
     * @return \IdeaEngine\TzStats\Model\InlineResponse2005ValueType
     */
     ...
     * Sets value_type
     *
     * @param \IdeaEngine\TzStats\Model\InlineResponse2005ValueType $value_type value_type
     *
     * @return self
     */

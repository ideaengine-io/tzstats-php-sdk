...
class Transaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['has_data'] = $data['has_data'] ?? null;
        $this->container['days_destroyed'] = $data['days_destroyed'] ?? null;
        $this->container['big_map_diff'] = $data['big_map_diff'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['has_data'] === null) {
            $invalidProperties[] = "'has_data' can't be null";
        }
        if ($this->container['days_destroyed'] === null) {
            $invalidProperties[] = "'days_destroyed' can't be null";
        }
        if ($this->container['big_map_diff'] === null) {
            $invalidProperties[] = "'big_map_diff' can't be null";
        }
        if ((count($this->container['big_map_diff']) < 1)) {
            $invalidProperties[] = "invalid value for 'big_map_diff', number of items must be greater than or equal to 1.";
        }
    ...
    public function setHash($hash)
    {
        ...
        if ((mb_strlen($hash) < 1)) {
            throw new \InvalidArgumentException('invalid length for $hash when calling Transaction., must be bigger than or equal to 1.');
        }
    ...
    public function setBlock($block)
    {
        ...
        if ((mb_strlen($block) < 1)) {
            throw new \InvalidArgumentException('invalid length for $block when calling Transaction., must be bigger than or equal to 1.');
        }
    ...
    public function setTime($time)
    {
        ...
        if ((mb_strlen($time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $time when calling Transaction., must be bigger than or equal to 1.');
        }
    ...
    public function setStatus($status)
    {
        ...
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling Transaction., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['has_data'];
    }

    /**
     * Sets has_data
     *
     * @param bool $has_data has_data
     *
     * @return self
     */
    public function setHasData($has_data)
    {
        $this->container['has_data'] = $has_data;
     ...
     * @return object[]
     */
    public function getBigMapDiff()
    {
        return $this->container['big_map_diff'];
    }

    /**
     * Sets big_map_diff
     *
     * @param object[] $big_map_diff big_map_diff
     *
     * @return self
     */
    public function setBigMapDiff($big_map_diff)
    {


        if ((count($big_map_diff) < 1)) {
            throw new \InvalidArgumentException('invalid length for $big_map_diff when calling Transaction., number of items must be greater than or equal to 1.');
        }
        $this->container['big_map_diff'] = $big_map_diff;
    ...
    public function setSender($sender)
    {
        ...
        if ((mb_strlen($sender) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sender when calling Transaction., must be bigger than or equal to 1.');
        }
    ...
    public function setReceiver($receiver)
    {
        ...
        if ((mb_strlen($receiver) < 1)) {
            throw new \InvalidArgumentException('invalid length for $receiver when calling Transaction., must be bigger than or equal to 1.');
        }
    ...
    public function setDelegate($delegate)
    {
        ...
        if ((mb_strlen($delegate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $delegate when calling Transaction., must be bigger than or equal to 1.');
        }

...
namespace IdeaEngine\TzStats\tzStats;
...
use IdeaEngine\TzStats\ApiException;
use IdeaEngine\TzStats\Configuration;
use IdeaEngine\TzStats\HeaderSelector;
...
class DefaultApi
{
     ...
     *
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IdeaEngine\TzStats\Model\InlineResponse2001
     */
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IdeaEngine\TzStats\Model\InlineResponse2001, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBlockchainConfigWithHttpInfo($head_blockheight)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\IdeaEngine\TzStats\Model\InlineResponse2001' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\IdeaEngine\TzStats\Model\InlineResponse2001', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\IdeaEngine\TzStats\Model\InlineResponse2001';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IdeaEngine\TzStats\Model\InlineResponse2001',
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IdeaEngine\TzStats\Model\InlineResponse2002
     */
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IdeaEngine\TzStats\Model\InlineResponse2002, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBlockchainTipWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\IdeaEngine\TzStats\Model\InlineResponse2002' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\IdeaEngine\TzStats\Model\InlineResponse2002', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\IdeaEngine\TzStats\Model\InlineResponse2002';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IdeaEngine\TzStats\Model\InlineResponse2002',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IdeaEngine\TzStats\Model\InlineResponse2003
     */
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IdeaEngine\TzStats\Model\InlineResponse2003, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExplorerAccountsAccountIdWithHttpInfo($hash, $meta = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\IdeaEngine\TzStats\Model\InlineResponse2003' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\IdeaEngine\TzStats\Model\InlineResponse2003', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\IdeaEngine\TzStats\Model\InlineResponse2003';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IdeaEngine\TzStats\Model\InlineResponse2003',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IdeaEngine\TzStats\Model\Baker[]
     */
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IdeaEngine\TzStats\Model\Baker[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getExplorerBakersWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\IdeaEngine\TzStats\Model\Baker[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\IdeaEngine\TzStats\Model\Baker[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\IdeaEngine\TzStats\Model\Baker[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IdeaEngine\TzStats\Model\Baker[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IdeaEngine\TzStats\Model\InlineResponse2004
     */
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IdeaEngine\TzStats\Model\InlineResponse2004, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExplorerBigmapIdWithHttpInfo($id, $prim = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\IdeaEngine\TzStats\Model\InlineResponse2004' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\IdeaEngine\TzStats\Model\InlineResponse2004', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\IdeaEngine\TzStats\Model\InlineResponse2004';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IdeaEngine\TzStats\Model\InlineResponse2004',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IdeaEngine\TzStats\Model\InlineResponse2005
     */
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IdeaEngine\TzStats\Model\InlineResponse2005, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExplorerBigmapIdUpdatesWithHttpInfo($id, $prim = null, $unpack = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\IdeaEngine\TzStats\Model\InlineResponse2005' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\IdeaEngine\TzStats\Model\InlineResponse2005', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\IdeaEngine\TzStats\Model\InlineResponse2005';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IdeaEngine\TzStats\Model\InlineResponse2005',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IdeaEngine\TzStats\Model\InlineResponse2006
     */
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IdeaEngine\TzStats\Model\InlineResponse2006, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExplorerBlockHashHeightHeadWithHttpInfo($hash_height_head, $meta = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\IdeaEngine\TzStats\Model\InlineResponse2006' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\IdeaEngine\TzStats\Model\InlineResponse2006', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\IdeaEngine\TzStats\Model\InlineResponse2006';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IdeaEngine\TzStats\Model\InlineResponse2006',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IdeaEngine\TzStats\Model\InlineResponse2007
     */
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IdeaEngine\TzStats\Model\InlineResponse2007, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExplorerContractHashWithHttpInfo($hash)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\IdeaEngine\TzStats\Model\InlineResponse2007' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\IdeaEngine\TzStats\Model\InlineResponse2007', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\IdeaEngine\TzStats\Model\InlineResponse2007';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IdeaEngine\TzStats\Model\InlineResponse2007',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IdeaEngine\TzStats\Model\Transaction[]
     */
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IdeaEngine\TzStats\Model\Transaction[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getExplorerContractHashCallsWithHttpInfo($hash, $unpack = null, $prim = null, $meta = null, $order = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\IdeaEngine\TzStats\Model\Transaction[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\IdeaEngine\TzStats\Model\Transaction[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\IdeaEngine\TzStats\Model\Transaction[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IdeaEngine\TzStats\Model\Transaction[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IdeaEngine\TzStats\Model\InlineResponse2008
     */
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IdeaEngine\TzStats\Model\InlineResponse2008, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExplorerContractHashScriptWithHttpInfo($hash)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\IdeaEngine\TzStats\Model\InlineResponse2008' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\IdeaEngine\TzStats\Model\InlineResponse2008', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\IdeaEngine\TzStats\Model\InlineResponse2008';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IdeaEngine\TzStats\Model\InlineResponse2008',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IdeaEngine\TzStats\Model\InlineResponse2009
     */
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IdeaEngine\TzStats\Model\InlineResponse2009, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExplorerContractHashStorageWithHttpInfo($hash, $meta = null, $prim = null, $unpack = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\IdeaEngine\TzStats\Model\InlineResponse2009' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\IdeaEngine\TzStats\Model\InlineResponse2009', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\IdeaEngine\TzStats\Model\InlineResponse2009';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IdeaEngine\TzStats\Model\InlineResponse2009',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IdeaEngine\TzStats\Model\InlineResponse20010
     */
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IdeaEngine\TzStats\Model\InlineResponse20010, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExplorerCycleHeadNumberWithHttpInfo($head_number)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\IdeaEngine\TzStats\Model\InlineResponse20010' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\IdeaEngine\TzStats\Model\InlineResponse20010', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\IdeaEngine\TzStats\Model\InlineResponse20010';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IdeaEngine\TzStats\Model\InlineResponse20010',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IdeaEngine\TzStats\Model\InlineResponse20011
     */
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IdeaEngine\TzStats\Model\InlineResponse20011, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExplorerElectionHeadHashNumberWithHttpInfo($head_hash_number)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\IdeaEngine\TzStats\Model\InlineResponse20011' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\IdeaEngine\TzStats\Model\InlineResponse20011', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\IdeaEngine\TzStats\Model\InlineResponse20011';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IdeaEngine\TzStats\Model\InlineResponse20011',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IdeaEngine\TzStats\Model\Operation[]
     */
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IdeaEngine\TzStats\Model\Operation[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getExplorerOpHashIdWithHttpInfo($hash_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\IdeaEngine\TzStats\Model\Operation[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\IdeaEngine\TzStats\Model\Operation[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\IdeaEngine\TzStats\Model\Operation[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IdeaEngine\TzStats\Model\Operation[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IdeaEngine\TzStats\Model\InlineResponse200
     */
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IdeaEngine\TzStats\Model\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function getIndexerStatusWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\IdeaEngine\TzStats\Model\InlineResponse200' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\IdeaEngine\TzStats\Model\InlineResponse200', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\IdeaEngine\TzStats\Model\InlineResponse200';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IdeaEngine\TzStats\Model\InlineResponse200',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IdeaEngine\TzStats\Model\Ticker[]
     */
     ...
     * @throws \IdeaEngine\TzStats\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IdeaEngine\TzStats\Model\Ticker[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getMarketsTickersWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\IdeaEngine\TzStats\Model\Ticker[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\IdeaEngine\TzStats\Model\Ticker[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\IdeaEngine\TzStats\Model\Ticker[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IdeaEngine\TzStats\Model\Ticker[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
